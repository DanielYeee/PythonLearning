...
class MainWindow(QMainWindow):
    ...
    def plot_gyro_data(self, gyro_data):
        x_data = [i for i in range(len(gyro_data))]
        y_data = [data[0] for data in gyro_data]
        z_data = [data[1] for data in gyro_data]
        w_data = [data[2] for data in gyro_data]
        ...
        self.canvas.axes.set_xlabel('Sample Index')
